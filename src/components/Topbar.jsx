...
const PAGE_META = {
  '/opportunities': { title: 'Opportunities',           sub: 'AI-matched results for your profile' },
  '/tracker':       { title: 'Application Tracker',     sub: 'Track every application in one place' },
  ...
  '/legit-check':   { title: 'Is This Legit? Checker',  sub: 'AI-powered scam and fraud detection' },
  '/notifications': { title: 'Notifications',            sub: 'Manage your alerts and followed orgs' },
  '/profile':       { title: 'Profile Settings',         sub: 'Update your info and advisor connection' },
}
    ...
    <div style={{
      ...
      <div>
        <div style={{ fontFamily: 'Sora, sans-serif', fontSize: 18, fontWeight: 700, color: 'var(--text)' }}>
          {isDashboard ? 'Dashboard' : meta.title}
        </div>
        <div style={{ fontSize: 12, color: 'var(--text2)', marginTop: 1 }}>
          {isDashboard ? 'Welcome back, ' + firstName : meta.sub}
        </div>
      </div>
